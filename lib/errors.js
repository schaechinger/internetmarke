...
module.exports = {
  ...
  usage: {
    ...
    missingProductClient: '3007: The product client credentials are required to make use of the product list. Please add credentials with internetmarke.enableProductList!',
